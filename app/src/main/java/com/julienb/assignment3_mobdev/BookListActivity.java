...
public class BookListActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ListView bookListView = (ListView) findViewById(R.id.menu_list);
        ...
        //Creating the adapter and giving it the book
        ArrayAdapter listViewAdapter = new ArrayAdapter<>(this, R.layout.book_item, DataSource.getBookNames(bookList));
        // Linking the list view and the adapter
        bookListView.setAdapter(listViewAdapter);
        ...
        bookListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                Book selectedItem = DataSource.getItemDetailsByName(BookListActivity.this.bookList, itemName);
